...
public class DriverManager {
	...
	private final static String IE_DRIVER_PROPERTY = "webdriver.ie.driver";
	...
	private WebDriver createLocalDriver() {
		...
		break;
		case INTERNETEXPLORER: System.setProperty(IE_DRIVER_PROPERTY, FileReaderManager.getInstance().getConfigFileReader().getDriverPath());
